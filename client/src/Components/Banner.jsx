  ...
  return (
    <div className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        <div className='text-white'>
           ...
           <p className='mt-2'>Monetize your vehicles effortlessely by listing it on rental</p>
           <p className='max-w-130'>We take care of insurance , driver verification and secure paayments so you can earn passive income ,stress free</p>
