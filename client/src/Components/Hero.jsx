...
const [pickupLocation,setPickupLocation] = useState('')
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
        ...
        <h1 className='text-4xl md:text-5xl font-semibold text-gray-800 hover:scale-105 transition-transform duration-300 sm:whitespace-nowrap'>Every Drive. First Class</h1>

        {/* <h6 className='text-1xl md:text-2xl font-semibold'>Browse a wide range of vehicles, compare prices, and book instantly — all in one place.
      </h6> */}
        ...
        <img src={assets.main_car} alt='car' className='max-h-74 hover:scale-105 transition-transform duration-300'></img>
