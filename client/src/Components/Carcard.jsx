...
const Carcard = ({car}) => {
  ...
  return (
    <div onClick={()=>{navigate(`/car-details/${car._id}`); scrollTo(0,0)}}  className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transistion-all duartion-500 cursor-pointer'>
